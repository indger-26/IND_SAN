# -*- coding: utf-8 -*-
"""DASH_IQA_NOVO_PARA_GIT.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1RQafWoys_EHBldM9WPHeFrMLxjHizupY
"""
...
# 1. GERAÇÃO DAS TABELAS A SEREM ALIMENTADAS
...
def ler_ajustar_arquivo ():
  ...
  # ----- INSERIR MÊS E ANO NO DETALHADO -----

  pos = iqa_detalhado.columns.get_loc("data_coleta")

  # Insere as novas colunas logo após data_coleta
  ...
  # ----- COMPLETAR COM COMBINAÇÕES FALTANTES (só parâmetros principais) -----
  ...
  # ----- JUNTAR COM "DEMAIS PARÂMETROS" EXISTENTES -----
  ...
  if mes == "November" or mes == "February" or mes == "May" or mes == "August":
    ...
    # ----- INSERIR TRIMESTRE E ANO CONTRATUAL NO DETALHADO -----

    pos_iqe = iqe_detalhado.columns.get_loc("id_amostra")

    # Insere as novas colunas logo após id_amostra
    ...
    # ----- AGRUPAMENTO -----
    colunas_chave_iqe = ["cidade", "parametros", "ETE"]  # ✅ ADICIONADO SES
...
#####
  ...
  #parametros = parametros.rename(columns={'parametros': 'parametro'})
...
# 2. ALIMENTANDO O BANCO DE DADOS
...
def graf_iqa_iqe (prestadora_sigla, mes):
  ...
  try:
    ...
    mapa_meses = {
        ...
        # Caso sua coluna esteja em português
        'janeiro': 1,
        'fevereiro': 2,
        'março': 3,
        'abril': 4,
    ...
    # Remover meses não reconhecidos
    ...
    # Criar uma coluna de data para facilitar
  ...
  if mes == "November" or mes == "February" or mes == "May" or mes == "August":
    ...
    try:
      ...
      # ============================================================
      # PEGAR SOMENTE O ÚLTIMO ANO CONTRATUAL
      # ============================================================
      ...
      # ============================================================
      # PADRONIZAR E ORDENAR OS TRIMESTRES
      # ============================================================
      ...
      # Ordenar pelos trimestres
      df_filtrado = df_filtrado.sort_values('trimestre')

      # Remover trimestres que não possuem dados
