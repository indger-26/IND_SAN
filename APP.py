...
# ALIMENTANDO INFORMAÇÕES AO MODELO DE RELATÓRIO
  ...
  def analise_mun(TAB_MUN, TAB_REALIZADAS, BASE_MUN_TIPO_completo, TAB_MUN_IQE, TAB_REALIZADAS_IQE, BASE_MUN_TIPO_IQE_completo):
    ...
    TAB_MUN_IQE["NAM REALIZ"] = (np.maximum(TAB_MUN_IQE['PLANO DE AMOSTRAGEM AJUSTADO - ARSAL'].fillna(0), TAB_MUN_IQE['ANALISES REALIZADAS'].fillna(0)) - TAB_MUN_IQE['EXPURGOS TOTAIS'].fillna(0)).astype(int)
    ...
    TAB_MUN_RESUMIDA_IQE["ANALISES REALIZADAS"] = TAB_MUN_RESUMIDA_IQE["ANALISES REALIZADAS"].round(0)
    ...
    TAB_MUN_RESUMIDA_VI_IQE["ANALISES REALIZADAS"] = TAB_MUN_RESUMIDA_VI_IQE["ANALISES REALIZADAS"].round(0)
  ...
  def analise_tipo(TAB_TIPO, TAB_REALIZADAS, BASE_MUN_TIPO_completo, TAB_TIPO_IQE, TAB_REALIZADAS_IQE, BASE_MUN_TIPO_IQE_completo):
    ...
    TAB_TIPO_FINAL_RESUMIDA_IQE["ANALISES CONFORMES"] = TAB_TIPO_FINAL_RESUMIDA_IQE["ANALISES CONFORMES"].round(0)
    ...
    TAB_TIPO_RESUMIDA_VI_IQE["ANALISES CONFORMES"] = TAB_TIPO_RESUMIDA_VI_IQE["ANALISES CONFORMES"].round(0)
